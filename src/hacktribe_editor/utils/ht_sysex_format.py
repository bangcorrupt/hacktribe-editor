...
pattern_index = Struct(
    "index_msb" / Default(Int8ul, 0x00),
    "index_lsb" / Default(Int8ul, 0x00),
)

address = Struct(
    "address" / Hex(Default(Int32ul, 0xFFFFFFFF)),
)
...
sysex_body = Switch(
    this.msg_id,
    {
        ...
        "write_flash": data,
        "execute_ram": mem_addr_len,
        "execute_loader": mem_addr_len,
