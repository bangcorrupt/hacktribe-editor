...
import hacktribe_editor.utils.ht_sysex_format as sysx_fmt

from hacktribe_editor.utils.ht_fmt_utils import build_dict, parse_bytes, init_struct
from hacktribe_editor.utils.ht_syx_codec import syx_enc, syx_dec
...
@log_debug
def init_sysex(msg_id="current_pattern_request", global_channel=0x30, product_id=0x124):
    """
