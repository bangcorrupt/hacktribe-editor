...
from hacktribe_editor.utils.ht_sysex_utils import (
    init_sysex,
    build_sysex,
    int_to_midi,
    calculate_address,
...
import hacktribe_editor.utils.ht_sysex_format as sysex_fmt
...
@log_debug
def add_groove(groove, max_groove_index, global_channel=0x30, product_id=0x124):
    """
    Return Write CPU RAM SysEx messages as bytes
