...
fx_control = Struct(
    ...
    'target_param' / Default(Int8ul, 0x00),
    Padding(1),
...
ifx_1_params = Switch(this.ifx_1_device, {
...
ifx_2_params = If(
    this.ifx_1_device in [
        'nofx_thru', 'I_cheap_comp', 'I_punch', 'I_eq_2_band', 'I_filter',
...
mfx_params = Switch(this.mfx_device, {
    'nofx_thru': nofx_thru_params,
    'nofx_mute': nofx_mute_params,
...
preset = Union(
    0,
    'bytes' / Default(Bytes(0x20c), bytes(0x20c)),
    'hex' / HexDump(Default(GreedyBytes, bytes(0x20c))),
    'struct' / Struct(
        Seek(0x01),
        ...
        'ifx_1_post_level' / Default(Int8ul, 0x40),
        'unk_bytes_a' / Default(Bytes(2), bytes([0x3f, 0x40])),
        'slot_1_index' / Default(Int8ul, 0x00),
        'ifx_1_pre_level' / Default(Int8ul, 0x7f),
        Seek(0x135),
        'ifx_1_params' / ifx_1_params,
        Seek(0x174),
        'ifx_2_device' / ifx_device,
        'ifx_2_post_level' / Default(Int8ul, 0x40),
        'unk_bytes_b' / Default(Bytes(2), bytes([0x3f, 0x40])),
        'slot_2_index' / Default(Int8ul, 0x01),
        'ifx_2_pre_level' / Default(Int8ul, 0x7f),
        Seek(0x17f),
        'ifx_2_params' / ifx_2_params,
        Seek(0x1be),
        'mfx_device' / mfx_device,
        'mfx_post_level' / Default(Int8ul, 0x40),
        'unk_bytes_c' / Default(Bytes(2), bytes([0x3f, 0x40])),
        'slot_3_index' / Default(Int8ul, 0x02),
        'mfx_pre_level' / Default(Int8ul, 0x7f),
        Seek(0x1c9),
        'mfx_params' / mfx_params,
        Seek(0x209),
        'unk_levels?' / Default(Bytes(2), bytes([0x7f, 0x7f])),
        Padding(1),
    ),
)
