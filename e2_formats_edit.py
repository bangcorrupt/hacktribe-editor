...
vsb_header = Struct('title' / Default(PaddedString(0x10, 'ascii'), 'KORG SYSTEM FILE'),
                    ...
                    'dev_id' / Default(Hex(Int16ub), 0x124), Padding(1, pattern=b'\xff'),
                    'dev_id' / Default(Hex(Int16ub), 0x124), Padding(4),
...
fx_control = Struct('source_control' / Default(Enum(Byte, FX_On=0x41,
                    ...
                    'max_value' / Default(Int8ul, 0x7f), Padding(1),
                    'max_value' / Default(Int8ul, 0x7f), Padding(20),
                    )
